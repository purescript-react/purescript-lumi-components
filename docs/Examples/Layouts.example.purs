  ...
  where
    render props =
      column_
        ...
        , h2_ "Centered layout (used on PP detail pages)"
        , example $
            Centered.layout $
                R.div
                  { children:
        ...
        , h2_ "One Column w/ Header layout (used on PP overview pages)"
        , example $
        ...
        , h2_ "One Column w/ Header layout (used on PP detail pages)"
        , example $
            OneColumnWithHeader.layout $
              { titleContent: R.text "Title"
              , additionalHeaderContent: p_ "subheader"
