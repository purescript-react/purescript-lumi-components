  ...
  pure $ column_ $
    intercalate [ vspace S16 ]
      ...
      , [ h4_ "Primary + Disabled"
        , example
            $ lumiElement button $ primary _{ content = [ R.text "Button" ], buttonState = Disabled }
        ]
      ...
      , [ h4_ "Secondary Small"
        , example
            $ lumiElement button $ secondary _{ content = [ R.text "Button" ], size = Small }
        ]
      , [ h4_ "Secondary Large"
        , example
            $ lumiElement button $ secondary _{ content = [ R.text "Button" ], size = Large }
        ]
      , [ h4_ "Secondary Extra Large"
        , example
            $ lumiElement button $ secondary _{ content = [ R.text "Button" ], size = ExtraLarge }
        ]
      , [ h4_ "Secondary + Disabled"
        , example
            $ lumiElement button $ secondary _{ content = [ R.text "Button" ], buttonState = Disabled }
        ]
      , [ h4_ "Icon button"
        , example
      ...
      , [ h4_ "Icon button"
        , example
            $ lumiElement button $ secondary _{ content = [ buttonIcon Plus, hspace S8, R.text "Add new item" ] }
        ]
      , [ h4_ "Icon button"
        , example
      ...
      , [ h4_ "Link style"
        , example
            $ lumiElement button $ linkStyle _{ content = [ R.text "Button w/ link style" ] }
        ]
      , [ h4_ "Loading (Medium/default)"
        , example
            $ lumiElement button $ primary _{ buttonState = Loading }
        ]
      , [ h4_ "Loading (Small) "
        , example
            $ lumiElement button $ primary _{ buttonState = Loading, size = Small }
        ]
      , [ h4_ "Loading (Large) "
        , example
            $ lumiElement button $ primary _{ buttonState = Loading, size = Large }
        ]
      , [ h4_ "Loading (ExtraLarge) "
        , example
            $ lumiElement button $ primary _{ buttonState = Loading, size = ExtraLarge }
        ]
      ]
  where
